...
if __name__ == '__main__':
    ...
    #card_number = file_handler.read_json("card_number.json")["card_numbers"]
    ...
    card_number_functions.hash_collision_search_time(info["hash"], info["bins_list"], info["last_digit"])